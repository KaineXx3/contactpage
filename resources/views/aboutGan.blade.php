...
<div class="container">
    <h2 class="text-center my-3">About GAN WEI LIN (CA21085)</h2>

    <div class="row g-0">
        <!-- First Column with Image -->
        <div class="col-auto">
            <img src="{{ asset('images/ganweilin.jfif') }}" class="rounded float-right" alt="...">
        </div>
            ...
            <div class="col">
                <div class="card hobby-card h-100">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text" >Study for some new knowledge to learn about latest technologies in the world.</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card hobby-card h-100" >
                    <div class="card-body text-center" >
                        ...
                        <p class="card-text">Love to listen to music.</p>
                    </div>
                </div>
            </div>
        </div>
